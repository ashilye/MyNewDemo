package com.maple.mynewdemo.snackbar
...
class AnimatedSnackbar(context: Context, attrs : AttributeSet? = null) : LinearLayout(context, attrs) {
    ...
    init {
        val view: View = inflate(context, R.layout.my_snackbar_view, this)
//        val view: View = inflate(context, R.layout.snackbar_view, this)
